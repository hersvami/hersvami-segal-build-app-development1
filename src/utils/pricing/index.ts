...
export { generateSolutionsFromScope, generateSolutionFromCategory } from './engine';
export { recogniseScope, recogniseScopeWithAI, getRelatedCategories, getAutoAddCategories, getSuggestedCategories, suggestContingency, getAllCategories, getGroupedCategories } from './scopeRecogniser';
