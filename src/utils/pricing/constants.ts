...
export const TRADE_MARKERS = ['Demo', 'Carpentry', 'Plumbing', 'Electrical', 'Tiling', 'Painting', 'Plastering', 'Waterproofing', 'Cabinetry', 'Flooring', 'Glass', 'Roofing', 'Landscaping', 'Concreting', 'Structural'] as const;
...
export const createStage = (name: string, trade: string, rate: number, unit: StageTemplate['unit'], duration: number, description: string): StageTemplate => ({
  name, trade, rate, unit, duration, description,
});
