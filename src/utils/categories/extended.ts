...
export const EXTENDED_CATEGORIES: WorkCategory[] = [
  ...
  cat('internalWalls', '🧱 Internal Walls', 'internalWalls', 'structural',
    [{ id: 'type', label: 'Type', type: 'select', options: ['New stud wall', 'Plasterboard repair', 'Niches'] }],
    [{ name: 'Stud Frame', trade: 'Carpentry', rate: 85, unit: 'area', duration: 1, description: 'Construct stud wall frame' },
     { name: 'Plasterboard', trade: 'Carpentry', rate: 65, unit: 'area', duration: 1, description: 'Sheet and finish' }],
    [],
    ['Frame and plasterboard', 'Setting and finishing'],
    ['Painting', 'Structural work'],
    [{ categoryId: 'painting', type: 'suggested' }, { categoryId: 'electrical', type: 'suggested' }],
  ),
  ...
  cat('fireSafety', '🔥 Fire & Safety', 'fireSafety', 'specialty',
    [{ id: 'type', label: 'Type', type: 'select', options: ['Smoke alarms', 'Fire doors', 'BAL rating'] }],
    [{ name: 'Smoke Alarm Install', trade: 'Electrical', rate: 250, unit: 'item', duration: 0.5, description: 'Install hardwired smoke alarm' }],
    [],
    ['AS3786 compliance', 'Hardwired interconnection'],
